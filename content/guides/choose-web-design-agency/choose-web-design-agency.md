...
<h2 class="title-3 entry__content--sidebar-excerpt">The agency you pick will shape your brand online for years — here's how to make that decision with your eyes open.</h2>
...
- [Questions to Ask on a Discovery Call](#discovery-questions)
- [How to Read a Proposal](#proposal-evaluation)
- [Contract Basics](#contract-basics)
- [Communication Expectations](#communication)
- [FAQ](#faq)
...
<h2 id="portfolio-evaluation">What to Look for in a Portfolio (Not Just Pretty Screenshots)</h2>
...
<h2 id="discovery-questions">Questions to Ask on a Discovery Call</h2>
...
1. **"Can you walk me through how a typical project goes from kickoff to launch?"** Listen for specificity. Do they describe a real process, or general-sounding steps?

2. **"What does the revision process look like? How many rounds are included, and how are they structured?"** This tells you whether they've dealt with scope creep before and built systems to manage it.

3. **"Who will actually be working on my project?"** Some agencies pitch you their senior team and hand the work to juniors. Ask directly who's on your account.

4. **"What happens if we go over scope?"** There will always be something that wasn't anticipated. How do they handle it?

5. **"Can you share a project that didn't go smoothly and how you handled it?"** A mature agency can answer this honestly. Evasion is a signal.

6. **"What do you need from us to do your best work?"** This tells you whether they've thought about the client relationship as a collaboration, not just a transaction.

7. **"What does success look like for this project — and how will you know if you've hit it?"** If they can't answer this, neither of you has a shared definition of done.

If you're also evaluating branding as part of your project, you may want to read our guide on [how to choose a branding agency](/guides/choose-branding-agency/) — the criteria overlap more than you'd think, and bundling both under one agency can simplify your project significantly.

<h2 id="proposal-evaluation">How to Read a Proposal</h2>
...
When comparing multiple proposals, resist the urge to pick based on price alone. A $10,000 proposal that includes clear scope and a defined process will often deliver more value than a $7,000 proposal that leaves everything open to interpretation. For a deeper look at what drives cost differences, our guide on [how much a website redesign costs in 2026](/guides/website-redesign-cost/) breaks down where the money actually goes.

<h2 id="contract-basics">Contract Basics</h2>
...
<h2 id="communication">Communication Expectations</h2>
...
<summary>How many agencies should I talk to before making a decision?</summary>
...
<details class="faq__item">
<summary>What's a reasonable budget for a professional website redesign?</summary>
...
<details class="faq__item">
<summary>How long does a web design project typically take?</summary>
...
<details class="faq__item">
<summary>Do I need to provide all the content before the project starts?</summary>
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How many agencies should I talk to before making a decision?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Three is a good number. It gives you enough contrast to make a meaningful comparison without turning vendor evaluation into a part-time job. Talk to one agency that's slightly above your budget, one that's in range, and one that's newer or smaller. The conversations alone will sharpen your thinking about what you actually need."
      }
    },
    {
      "@type": "Question",
      "name": "What's a reasonable budget for a professional website redesign?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "For a custom website redesign from a professional agency — strategy, design, and development — expect to invest somewhere between $10,000 and $50,000 depending on the size and complexity of your site. Simple marketing sites for small businesses tend to land in the $10,000–$20,000 range. More complex builds with custom integrations, e-commerce, or multiple stakeholders go higher. Template-based work from smaller studios can come in below $10,000, but scope the deliverables carefully."
      }
    },
    {
      "@type": "Question",
      "name": "How long does a web design project typically take?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A full website redesign — discovery through launch — typically takes 8 to 16 weeks with an experienced agency. That timeline assumes active participation on your end: timely feedback, content that's reasonably ready, and internal approvals that don't take two weeks per round. Projects with delayed client feedback are the most common reason timelines stretch."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need to provide all the content before the project starts?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You don't need everything on day one, but you should have a clear plan. Agencies can work with placeholder content during the design phase, but real content — real headlines, real copy, real images — is essential before development begins. Sites designed around placeholder text often require significant rework once real content is dropped in. If copywriting or photography isn't your strong suit, ask your agency whether they offer those services or can refer you to someone who does."
      }
