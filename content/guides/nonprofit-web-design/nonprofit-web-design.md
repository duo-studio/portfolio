...
<h2 class="title-3 entry__content--sidebar-excerpt">
    Nonprofit websites carry more weight than any other kind. Here's how to build one that earns trust, tells your story, and converts supporters into donors.
</h2>
<div class="entry__content--sidebar-toc">

### Table of Contents:
- [More Than a Marketing Site](#more-than-marketing)
- [Design as a Trust Signal](#trust-signal)
- [Telling Your Story Visually](#impact-storytelling)
- [Accessibility Isn't Optional](#accessibility)
...
<h2 id="more-than-marketing">More Than a Marketing Site</h2>
...
<h2 id="trust-signal">Design as a Trust Signal</h2>
...
<h2 id="impact-storytelling">Telling Your Story Visually</h2>
...
This is where the investment in good design pays off in ways that are hard to quantify but easy to observe. When we worked with [Amparo](https://duo-studio.co/work/){target="_blank"}, the site's front page had been leading with organizational history and program descriptions — information that matters to grant writers and no one else. We moved the program participants to the front: real faces, short stories, immediate stakes. The data came second, as evidence of what those stories represented. That reorder changed how quickly visitors understood what the organization actually did.
...
<h2 id="accessibility">Accessibility Isn't Optional</h2>
...
[WCAG 2.1 AA](https://www.w3.org/WAI/WCAG21/quickref/){target="_blank"} — the Web Content Accessibility Guidelines — is the standard to target. The core requirements include:
...
<h2 id="fundraising-ux">Fundraising UX That Actually Works</h2>
...
<h2 id="content-management">Content Management for Small Teams</h2>
